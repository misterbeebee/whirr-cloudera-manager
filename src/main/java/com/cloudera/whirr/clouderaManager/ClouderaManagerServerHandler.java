...
public class ClouderaManagerServerHandler extends ClusterActionHandlerSupport {

  public static final String ROLE = "cloudera_manager_server";
  ...
  protected void beforeBootstrap(ClusterActionEvent event) throws IOException {
    addStatement(event, call("install_cloudera_manager_server"));
  }
  ...
  protected void afterConfigure(ClusterActionEvent event) throws IOException,
    ...
    Set<Instance> nodes = cluster.getInstancesMatching(role(ClouderaManagerNodeHandler.ROLE));
